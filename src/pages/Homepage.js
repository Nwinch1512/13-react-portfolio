...
const bgImg = require("../images/pexels-phil-desforges-15496986.jpg");
              ...
              <div className="card-1">
                <div className="card-body" id="about">
                  ...
                  <p className="about">
                    ...
                    analysis and project management experience in both the
                    public and private sector, as per my{" "}
                    <a href="../CV.pdf">CV</a>. I'm highly organised and a great
                    problem solver. I enjoy working alone and in a team. I'm
                    currently learning web developer skills through the
                    University of Birmingham front end developer bootcamp in
                    partnership with edx. I'm excited to develop my technical
